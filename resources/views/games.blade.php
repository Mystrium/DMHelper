                ...
                <a href="/story/{{$game->id}}" style="text-decoration: none">
                    <div class="game-card" style="background-image: url('https://via.placeholder.com/500x300');">
                        ...
                        <div class="flex position-absolute bottom-0 end-0 mb-2">
                            <a href="/play/{{$game->id}}" class="btn btn-success btn-sm me-1">
                            ...
                            <button onclick="changeGame(event, '{{$game->title}}', '{{$game->setting}}', '{{$game->music_list_id}}', '{{$game->id}}')" data-bs-toggle="modal" data-bs-target="#changeGameModal" type="submit" class="btn btn-warning btn-sm me-5">
