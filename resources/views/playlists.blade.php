            ...
            <div class="col-md-4 mb-4">
                <a href="/music/{{$playlist->id}}" style="text-decoration: none">
                    <div class="game-card" style="background-image: url('https://img.youtube.com/vi/{{isset($playlist->music[0]) ? $playlist->music[mt_rand(0,count($playlist->music) - 1)]->youtube_url : ''}}/0.jpg');">
                        ...
                        <button onclick="changeList(event, '{{$playlist->title}}', '{{$playlist->description}}', '{{$playlist->id}}')" data-bs-toggle="modal" data-bs-target="#changePlaylistModal" type="submit" class="btn btn-warning btn-sm position-absolute bottom-0 end-0 mb-2 me-5">
